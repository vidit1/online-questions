...
int main()
{
    ...
    printf("\nDATA ENTERED IN THE LINKED LIST SHOULD BE IN ASCENDING ORDER\n");
    printf("\nEnter data to the first linked list");
    printf("\nEnter data to the node: ");
    //Storing some data
    scanf("%d",&new_node->data);
    ...
    display(head);
	printf("\nEnter data to the second linked list");
    printf("\nEnter data to the node: ");
    //Storing some data
    scanf("%d",&new_node->data);
    //head pointing to the new node
